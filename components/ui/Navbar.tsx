...
export const NavbarLogo = () => {
  return (
    <a href="#" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black">
      <img src="/logo.svg" alt="SpaceScope logo" width={30} height={30} />
      <span className="font-medium text-black dark:text-white">SpaceScope</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  return (
    ...
    <Tag href={(href as string) || undefined} className={cn(baseStyles, variantStyles[variant], className)} {...(props as any)}>
      {children}
    </Tag>
  );
};
